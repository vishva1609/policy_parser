...
# Point tika at the local JAR so it doesn't try to download one
_JAR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'tika-server-standard-3.1.0.jar')
os.environ.setdefault('TIKA_SERVER_JAR', _JAR)

import tika
tika.initVM()  # noqa: E402  (import after env var is set)
...
# ---------------------------------------------------------------------------
# 1. PDF Parsing using Apache Tika
# ---------------------------------------------------------------------------
